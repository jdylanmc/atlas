...
export declare const operationResultSchemaVersion = "1.0.0";
export declare const operationHandoffSchemaVersion = "1.0.0";
...
export interface OperationHandoff<Operation extends OperationIdentity = OperationIdentity> {
...
export interface OperationResult<Operation extends OperationIdentity = OperationIdentity, Handoff extends OperationHandoff<Operation> = OperationHandoff<Operation>, Payload = unknown> {
