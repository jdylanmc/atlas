...
The following is a fictional renderer example, not an Atlas Site theming
decision. Only record rejections actually approved by the maintainer.
Lower priority, `post-mvp`, or an open prerequisite is not a rejection.
