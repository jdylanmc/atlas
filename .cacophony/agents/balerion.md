...
<agent-composition compatibility-id="balerion" source=".cacophony/compositions.json" generated-by="scripts/cacophony_agents.py">
<composition-precedence directives="listed-later-wins" persona="presentation-only-directives-win"/>
<agent-persona id="balerion" source=".cacophony/personas/balerion.md">
# Agent Persona
...
<agent-directive order="1" id="security-and-runtime-risk-review" source=".cacophony/directives/security-and-runtime-risk-review.md" authority="behavior">
# Agent Directive
